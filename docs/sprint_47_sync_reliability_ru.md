...
механизм передачи. Sprint 47B вынесен в отдельный PR с fault-injection и полным
...
В отдельный Sprint 47B вынесены расширенные end-to-end проверки передачи файлов:
...
девяти сценариев исходного Sprint 47. Реализация и итоговая матрица описаны в
`docs/sprint_47b_transfer_fault_injection_ru.md`; правила protocol v3 не меняются.
